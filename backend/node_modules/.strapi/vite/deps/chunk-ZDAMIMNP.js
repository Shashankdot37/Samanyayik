import {
  ...
  QueryClientProvider,
  img
} from "./chunk-CDT5BCLE.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-VSSG76MP.js";
import {
  useAIAvailability,
  useNpsSurveySettings
} from "./chunk-P75D4ZZQ.js";
import {
  useGetAIUsageQuery
} from "./chunk-47UALI3V.js";
import {
  GuidedTourContext
} from "./chunk-M5BUUU2H.js";
import {
  require_pick
} from "./chunk-7B4RO2FD.js";
import {
  getBasename
...
import {
  useEnterprise
} from "./chunk-CTNZAUU5.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-CNVSB47Y.js";
import {
  Login
} from "./chunk-3AS6QP3L.js";
import {
  MemoizedInputRenderer
} from "./chunk-X52CKU6G.js";
import {
  Form
} from "./chunk-F2GIFY72.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-JBI2DDE3.js";
import {
  ConfigurationProvider
} from "./chunk-QKPHL6VA.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-JS2P54O4.js";
import {
  require_baseRest
} from "./chunk-PPJAZDSJ.js";
import {
  HistoryProvider
...
} from "./chunk-4XZBYLSZ.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-R6Q3YFXP.js";
import {
...
// node_modules/@strapi/admin/node_modules/invariant/browser.js
var require_browser = __commonJS({
  "node_modules/@strapi/admin/node_modules/invariant/browser.js"(exports, module2) {
    "use strict";
...
// node_modules/@strapi/admin/node_modules/json-logic-js/logic.js
var require_logic = __commonJS({
  "node_modules/@strapi/admin/node_modules/json-logic-js/logic.js"(exports, module2) {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-4CE7AUAV.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-LN7AKRBI.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-PH6CKUZS.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-FPRTDY7L.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-BNRQN55W.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-ZMTSQO75.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-BXEY6OVD.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ESSFM2QF.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-GYSUM53X.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-OMLB2YUI.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-LPET7G7Z.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-CEKIWMRD.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-SYV3BVIF.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-7EQPTJWR.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-3ELFDEDS.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-JGBRVH57.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-HKHLWF4V.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-YMXVBNMD.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-AXAYAEDV.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-CPZ3YWV6.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-K5HNTMAR.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-OF7KBU4F.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-IPAKRYGX.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-GUJPEL6K.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-L5COGHQ2.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-E5WWZYFM.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-XMHIBKCZ.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-LLXIZA7V.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-KVE5AFNS.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-HQOBDU4H.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-HQOBDU4H.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-L3BHCOBZ.js");
...
//# sourceMappingURL=chunk-ZDAMIMNP.js.map
