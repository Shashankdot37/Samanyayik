...
>
  {/* Heading at top */}
  <div className="w-full flex justify-center mt-8" style={{marginBottom:"20vh"}}>
    <h1
    ...
    >
      ...
      {/* Carousel layout */}
      <div className="flex items-center justify-center w-full max-w-6xl mx-auto mt-12 relative">
        {/* Previous Button */}
        <button
          onClick={prevTestimonial}
          className="absolute left-0 flex flex-col items-center justify-center group cursor-pointer"
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 w-full">
          ...
          {/* Right: Review Box */}
          <div
            className="bg-white text-black p-6 lg:p-8 rounded-tr-[40px] rounded-bl-[40px] max-w-xl w-full opacity-80"
        ...
        <button
          ...
          className="absolute right-0 flex flex-col items-center justify-center group cursor-pointer"
          style={{ color: "#FFEEAD", fontSize: "5rem" }}
        >
          <span className="absolute inset-0 rounded-full border-2 border-yellow-200 opacity-0 scale-0 group-hover:opacity-50 group-hover:scale-110 transition-all duration-300"></span>
          <span className="relative z-10 text-yellow-200 group-hover:text-white select-none text-5xl">
